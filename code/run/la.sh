...
function post {
  ...
  # python $post_dir'gen_json_topk.py' $para_file
  ...
  # plot the precision of the three methods
  # python $post_dir'plot_precision.py' $para_file

  # plot the locations of different events
  python $post_dir'plotter.py' $para_file
}
